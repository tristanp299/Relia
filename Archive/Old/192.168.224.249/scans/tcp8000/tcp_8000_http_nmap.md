# Nmap 7.94SVN scan initiated Tue Apr  2 20:58:27 2024 as: nmap -vv --reason -Pn -T4 -T4 --min-rate=500 -sV -p 8000 "--script=banner,(http* or ssl*) and not (brute or broadcast or dos or external or http-slowloris* or fuzzer)" -oN /home/kali/Documents/Relia/results/192.168.224.249/scans/tcp8000/tcp_8000_http_nmap.txt -oX /home/kali/Documents/Relia/results/192.168.224.249/scans/tcp8000/xml/tcp_8000_http_nmap.xml 192.168.224.249
Nmap scan report for 192.168.224.249
Host is up, received user-set (0.086s latency).
Scanned at 2024-04-02 20:58:27 PDT for 155s

Bug in http-security-headers: no string output.
PORT     STATE SERVICE REASON          VERSION
8000/tcp open  http    syn-ack ttl 125 Apache httpd 2.4.54 ((Win64) OpenSSL/1.1.1p PHP/7.4.30)
| http-headers: 
|   Date: Wed, 03 Apr 2024 03:58:49 GMT
...
|_192.168.224.249:8000/?p4yl04d3=<script>alert(document.cookie)</script>
|_http-server-header: Apache/2.4.54 (Win64) OpenSSL/1.1.1p PHP/7.4.30
|_http-litespeed-sourcecode-download: Request with null byte did not work. This web server might not be vulnerable
|_http-malware-host: Host appears to be clean
| http-trace: TRACE is enabled
| Headers:
| Date: Wed, 03 Apr 2024 03:58:44 GMT
| Server: Apache/2.4.54 (Win64) OpenSSL/1.1.1p PHP/7.4.30
| Connection: close
| Transfer-Encoding: chunked
|_Content-Type: message/http
|_http-chrono: Request times for /dashboard/; avg: 489.55ms; min: 221.10ms; max: 1319.41ms
| http-referer-checker: 
| Spidering limited to: maxpagecount=30
|_  http://code.jquery.com:80/jquery-1.10.2.min.js
|_http-jsonp-detection: Couldn't find any JSONP endpoints.
|_http-date: Wed, 03 Apr 2024 03:58:45 GMT; 0s from local time.
...
| http-php-version: Logo query returned unknown hash c536b586d3b16f4b1cf37b4ad3270286
|_Credits query returned unknown hash c536b586d3b16f4b1cf37b4ad3270286
|_http-fetch: Please enter the complete path of the directory to save data in.
|_http-favicon: Unknown favicon MD5: 6EB4A43CB64C97F76562AF703893C8FD
|_http-feed: Couldn't find any feeds.
| http-useragent-tester: 
|   Status for browser useragent: 200
|   Redirected To: http://192.168.224.249:8000/dashboard/
|   Allowed User Agents: 
...
| http-grep: 
|   (1) http://192.168.224.249:8000/dashboard/: 
|     (1) email: 
|       + fastly-logo@2x.png
|   (2) http://192.168.224.249:8000/dashboard/stylesheets/all.css: 
|     (2) email: 
|       + social-icons@2x.png
|       + social-icons-large@2x.png
|   (3) http://192.168.224.249:8000/dashboard/phpinfo.php: 
|     (2) ip: 
|       + 192.168.224.249
|       + 192.168.45.189
|     (1) email: 
|       + license@php.net
|   (1) http://192.168.224.249:8000/dashboard/faq.html: 
|     (1) email: 
|_      + your-gmail-username@gmail.com
...
|   
|   Error Code: 403
|_  	http://192.168.224.249:8000/phpmyadmin/
...
|     
|     Path: http://192.168.224.249:8000/dashboard/stylesheets/all.css
|     Line number: 559
|     Comment: 
...
|     
|     Path: http://192.168.224.249:8000/dashboard/javascripts/all.js
|     Line number: 4912
|     Comment: 
...
|     
|     Path: http://192.168.224.249:8000/dashboard/stylesheets/normalize.css
|     Line number: 311
|     Comment: 
|         /*
...
|     
|     Path: http://192.168.224.249:8000/applications.html
|     Line number: 46
|     Comment: 
...
|     
|     Path: http://192.168.224.249:8000/dashboard/docs/install-wordpress.html
|     Line number: 50
|     Comment: 
|         <!-- Right Nav Section -->
|     
...
|     Line number: 5686
|     Comment: 
|_        /* line 93, /home/bitnami/projects/apachefriends-web/bower_components/foundation/scss/foundation/components/_tooltips.scss */
| http-enum: 
...
# Nmap done at Tue Apr  2 21:01:02 2024 -- 1 IP address (1 host up) scanned in 155.61 seconds
